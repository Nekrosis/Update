...
public class Main {
    public static  void main(String[] args) {
        ...
        File dir = new File("/Users/macbookpro/Games");
        if (dir.mkdir()) {
            stringBuilder.append(dir.getName() + " - dir create");
            stringBuilder.append("\n");
        }
        for (String s : listDir) {
            File dirs = new File("/Users/macbookpro/Games", s);
            if (dirs.mkdirs()) {
        ...
        for (String listRe : resDir) {
            File dirsRes = new File("/Users/macbookpro/Games/res", listRe);
            if (dirsRes.mkdirs()) {
        ...
        for (String src : srcDir) {
            File dirsSrc = new File("/Users/macbookpro/Games/src", src);
            if (dirsSrc.mkdirs()) {
                stringBuilder.append(dirsSrc.getName() + " - dir create");
                stringBuilder.append("\n");
            }
        }
        File file1 = new File("/Users/macbookpro/Games/src/main", "Main.java");
        File file2 = new File("/Users/macbookpro/Games/src/main", "Utils.java");
        File file3 = new File("/Users/macbookpro/Games/temp", "text.txt");
        try {
